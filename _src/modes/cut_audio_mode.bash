...
#----------------
# Name          : cut_audio_mode.bash
# Description   : Run audio-cut process to output ffmpeg commands to a file for batch conversion
#----------------
...
cut_video_mode() {
  ...
  while true; do
    ...
    ffmpeg_command="`get_ffmpeg_cut_audio_command $input_file $duration $codec $dimensions $tune $preset $crop $queue_size $crf $output_dir $name`"
