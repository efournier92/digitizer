...
get_capture_audio_command() {
  ...
  echo "ffmpeg -f $input_format -sample_rate $sample_rate -thread_queue_size $threads -i $audio_device -ac $channels -t $stop_time -f $output_format - | ffmpeg -i - -c copy $output_location -c copy -f $output_format pipe:play | ffplay -i pipe:play -nodisp"
}
