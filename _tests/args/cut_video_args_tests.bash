...
test_reading_cut_video_args_with_all_short_args() {
  ...
  local expected_result="$input_file $codec `default_video_output_dimensions` `default_tune` `default_preset` `default_crop` `default_max_queue` `default_crf` $output_dir"
