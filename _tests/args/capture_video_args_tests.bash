...
test_capture_video_args_video_device_short_arg() {
...
test_capture_video_args_video_device_first_long_arg() {
  local message="Result should contain the configured video_device."
  local test_video_device="/dev/video9"
  local test_audio_device="hw:9,9"
  time_now() { echo "200909185525" ; }
...
test_capture_video_args_video_device_second_long_arg() {
  local message="Result should contain the configured video_device."
  local test_video_device="/dev/video9"
  local test_audio_device="hw:9,9"
  time_now() { echo "200909185525" ; }
...
test_capture_video_args_audio_device_short_arg() {
...
test_capture_video_args_audio_device_long_arg() {
  local message="Result should contain the configured audio_device."
  local test_video_device="/dev/video9"
  local test_audio_device="hw:9,9"
  time_now() { echo "200909185525" ; }
...
test_capture_video_args_codec_short_arg() {
...
test_capture_video_args_codec_long_arg() {
  local message="Result should contain the configured codec."
  local codec="test_codec"
  local test_video_device="/dev/video9"
  local test_audio_device="hw:9,9"
...
test_capture_video_args_output_directory_short_arg() {
...
test_capture_video_args_output_directory_long_arg() {
  local message="Result should contain the configured output_dir."
  local output_dir="TestDirectory"
  local test_video_device="/dev/video9"
  local test_audio_device="hw:9,9"
...
test_capture_video_args_stop_time_short_arg() {
...
test_capture_video_args_stop_time_long_arg() {
  local message="Result should contain the configured stop_time."
  local stop_time="99:99:99.999"
  local test_video_device="/dev/video9"
  local test_audio_device="hw:9,9"
...
test_capture_video_args_output_name_short_arg() {
...
test_capture_video_args_output_name_long_arg() {
  local message="Result should contain the configured output_name."
  local output_name="MyOutput"
  local test_video_device="/dev/video9"
  local test_audio_device="hw:9,9"
...
test_capture_video_args_video_format_long_arg() {
...
test_capture_video_args_audio_format_long_arg() {
...
test_capture_video_args_crf_long_arg() {
...
test_capture_video_args_preset_long_arg() {
...
test_capture_video_args_size_long_arg() {
...
test_capture_video_args_standard_long_arg() {
...
test_capture_args_threads_long_arg() {
...
test_capture_video_args_tune_long_arg() {
...
test_capture_video_args_all_args() {
