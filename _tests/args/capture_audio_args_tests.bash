...
test_capture_audio_args_with_no_args() {
  ...
  local expected_result="`get_audio_device_selection` `default_audio_input_format` `default_audio_output_format` `default_num_audio_channels` `default_audio_sample_rate` `default_max_threads` `default_audio_stop_time` `default_audio_file_location`"
...
test_capture_audio_args_with_audio_device_first_short_arg() {
  ...
  time_now() { echo "200909185525" ; }
  get_audio_device_selection() { echo "$test_audio_device" ; }
  local expected_result="$test_audio_device `default_audio_input_format` `default_audio_output_format` `default_num_audio_channels` `default_audio_sample_rate` `default_max_threads` `default_audio_stop_time` `default_audio_file_location`"
...
test_capture_audio_args_with_input_format_short_arg() {
  ...
  time_now() { echo "200909185525" ; }
  get_audio_device_selection() { echo "$test_audio_device" ; }
  local expected_result="`get_audio_device_selection` $test_input_format `default_audio_output_format` `default_num_audio_channels` `default_audio_sample_rate` `default_max_threads` `default_audio_stop_time` `default_audio_file_location`"
...
test_capture_audio_args_with_output_format_short_arg() {
  ...
  time_now() { echo "200909185525" ; }
  get_audio_device_selection() { echo "$test_audio_device" ; }
  local expected_result="`get_audio_device_selection` `default_audio_input_format` $test_output_format `default_num_audio_channels` `default_audio_sample_rate` `default_max_threads` `default_audio_stop_time` `default_audio_file_location`"
...
test_capture_audio_args_with_stop_time_short_arg() {
  ...
  time_now() { echo "200909185525" ; }
  get_audio_device_selection() { echo "$test_audio_device" ; }
  local expected_result="`get_audio_device_selection` `default_audio_input_format` `default_audio_output_format` `default_num_audio_channels` `default_audio_sample_rate` `default_max_threads` $test_stop_time `default_audio_file_location`"
...
test_capture_audio_args_with_sample_rate_long_arg() {
  ...
  time_now() { echo "200909185525" ; }
  get_audio_device_selection() { echo "$test_audio_device" ; }
  local expected_result="`get_audio_device_selection` `default_audio_input_format` `default_audio_output_format` `default_num_audio_channels` $test_sample_rate `default_max_threads` `default_audio_stop_time` `default_audio_file_location`"
...
test_capture_audio_args_with_max_threads_long_arg() {
  ...
  time_now() { echo "200909185525" ; }
  get_audio_device_selection() { echo "$test_audio_device" ; }
  local expected_result="`get_audio_device_selection` `default_audio_input_format` `default_audio_output_format` `default_num_audio_channels` `default_audio_sample_rate` $test_max_threads `default_audio_stop_time` `default_audio_file_location`"
...
test_capture_audio_args_with_output_dir_and_name_short_args() {
  ...
  time_now() { echo "200909185525" ; }
  get_audio_device_selection() { echo "$test_audio_device" ; }
  local expected_result="`get_audio_device_selection` `default_audio_input_format` `default_audio_output_format` `default_num_audio_channels` `default_audio_sample_rate` `default_max_threads` `default_audio_stop_time` $test_output_dir/$test_output_name"
